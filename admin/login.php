...
if (is_logged_in()) { header('Location: /admin/index.php'); exit; }
...
<div class="login-card">
    ...
    <?php if ($error): ?>
    <div class="alert alert-error"><span class="msi">error</span><?= htmlspecialchars($error) ?></div>
    <?php endif; ?>
    ...
    <p class="login-hint">Default: <code>admin</code> / <code>password</code> — change in <code>auth.php</code></p>
    <a href="/index.php" class="back-link"><span class="msi" style="font-size:15px">arrow_back</span> Back to site</a>
</div>
</body>
</html>
